  ...
  return (
    <AppBackground>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Section title="Who can tag you">
          <NextButton leftIcon={appImages.dummyuser} label="Everyone" onPress={() => {}} />
          <NextButton leftIcon={appImages.dummyuser} label="People you follow" onPress={() => {}} />
          <NextButton leftIcon={appImages.dummyuser} label="No one" onPress={() => {}} />
        </Section>
        <Section title="Who can mention you">
          <NextButton leftIcon={appImages.dummyuser} label="Everyone" onPress={() => {}} />
          <NextButton leftIcon={appImages.dummyuser} label="People you follow" onPress={() => {}} />
          <NextButton leftIcon={appImages.dummyuser} label="No one" onPress={() => {}} />
        </Section>
