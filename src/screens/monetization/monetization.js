  ...
  return (
    <AppBackground>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Section title="Tools">
          <NextButton leftIcon={appImages.dummyuser} label="Badges" onPress={() => {}} />
          <NextButton leftIcon={appImages.dummyuser} label="Subscriptions" onPress={() => {}} />
          <NextButton leftIcon={appImages.dummyuser} label="Bonuses" onPress={() => {}} />
        </Section>
        <Section title="Settings">
          <NextButton leftIcon={appImages.dummyuser} label="Payment Methods" onPress={() => {}} />
        </Section>
      </ScrollView>
    </AppBackground>
  );
